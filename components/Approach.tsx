    ...
    <section className='w-full py-20'>
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4 mx-auto px-8">
        <Card 
            ...
            description="We'll collaborate to map out your website's goals, target audience, and key functionalities. We'll discuss things like site structure, navigaton, and content requirements"
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
...
const Card = ({
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2]  max-w-sm w-full lg:h-[30rem] mx-auto p-4 relative h-[15rem]"
    >
